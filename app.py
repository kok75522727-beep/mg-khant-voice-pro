...
def inject_css() -> None:
    ...
    [data-testid="stDownloadButton"] > button { background:linear-gradient(135deg,#4f46e5 0%,#c026d3 100%)!important; color:#fff!important; border:1px solid #f5d0fe88!important; border-radius:14px!important; min-height:52px!important; font-weight:800!important; box-shadow:0 8px 20px #4f46e555!important; }
    [data-testid="stDownloadButton"] > button p { color:#fff!important; font-weight:800!important; }
    [data-testid="stDownloadButton"] > button:hover { background:linear-gradient(135deg,#6366f1 0%,#db2777 100%)!important; color:#fff!important; transform:translateY(-2px); }
