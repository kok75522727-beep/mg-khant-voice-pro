...
def inject_css() -> None:
    ...
    div[role="radiogroup"] { display:grid!important; grid-template-columns:repeat(3,minmax(0,1fr)); gap:12px!important; margin:10px 0 18px!important; }
    div[role="radiogroup"] > label { min-height:92px!important; padding:14px 8px!important; border:1px solid #818cf866!important; border-radius:16px!important; background:linear-gradient(145deg,#25245b,#10172f)!important; display:flex!important; align-items:center!important; justify-content:center!important; text-align:center!important; transition:.2s!important; }
    ...
    @media (max-width:600px) { div[role="radiogroup"] { grid-template-columns:repeat(3,minmax(0,1fr)); gap:7px!important; } div[role="radiogroup"] > label { min-height:76px!important; padding:8px 3px!important; } div[role="radiogroup"] > label p { font-size:12px!important; } }
